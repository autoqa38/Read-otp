...
describe('My Login application', () => {
    ...
    it.only('Validate if Appropriate text message is received to Collab and Assignee', async () => {
    ...
    listOfMessages1.forEach((firstmessage) => {
      console.log('****************************************************************************************************')
          console.log('Entire firstmessage ==========>' + JSON.stringify(firstmessage, null, "\t"))
          console.log('Message body ==========>' + JSON.stringify(firstmessage.body))
          console.log('Sent From ==========>' + JSON.stringify(firstmessage.from))
          console.log('Sent To ==========>' + JSON.stringify(firstmessage.to))
    ...
    it.skip('Validate if Appropriate text message is received to submitter', async () => {
        //await LoginPage.open();
        await LoginPage.invokeURL('https://app-stage.comcate.com/crm/2ysz1dvfru');
        await submissionPage.reportAnIssue.waitForDisplayed()
        await submissionPage.descriptionBox.setValue('This is test submission')
        ...
        await submissionPage.firstName.setValue('Praful')
        await submissionPage.lastName.setValue('Kolhe')
        await submissionPage.phoneNumber.setValue('8587589537')
        await browser.pause(1000)
        await submissionPage.submitButton.click()
